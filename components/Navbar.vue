  ...
  <div>
    <header class="nav-opt-sprite nav-locate-us nav-lang-en nav-ssl nav-unrec">
      <div class="container-fluid dekstop-nav">
        ...
        <div class="row">
          <!-- Delivery -->
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm2 pl-2">
          ...
          <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
            <div class="nav-tools">
              ...
              <nuxt-link to="/cart" class="nav-a nav-a-2" id="nav-cart">
                <span area-hidden="true" class="nav-line-1"></span>
                <span area-hidden="true" class="nav-line-2">Cart</span>
...
export default {
  ...
  computed: {
    showCountry() {
      if (this.$auth.$state.user.address !== null) {
        return this.$auth.$state.user.address.country;
      } else {
        return "Lithuania";
      }
    },
